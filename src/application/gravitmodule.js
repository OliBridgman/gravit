(function (_) {
    ...
    GravitModule.prototype.init = function () {
        ...
        gravit.actions.push(
            ...
            new GMagnificationAction(50, [GKey.Constant.META, '5']),
            new GMagnificationAction(100, [GKey.Constant.META, '1']),
            new GMagnificationAction(200, [GKey.Constant.META, '2']),
            new GMagnificationAction(400, [GKey.Constant.META, '4']),
            new GMagnificationAction(800, [GKey.Constant.META, '8']),
            new GZoomInAction(),
            new GZoomOutAction(),

            new GPaintModeAction(GScenePaintConfiguration.PaintMode.Full),
            new GPaintModeAction(GScenePaintConfiguration.PaintMode.Fast),
            new GPaintModeAction(GScenePaintConfiguration.PaintMode.Outline),
