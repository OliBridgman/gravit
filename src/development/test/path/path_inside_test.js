...
//                        yPt = 190;
                ...
                case 1:
                    ...
                    vertexSource = new IFVertexContainer(5);
                    ...
                    vertexCurve = new IFVertexContainer(5);
                    vertexCurve.addVertex(IFVertex.Command.Move, x1, y1);
                    vertexCurve.addVertex(IFVertex.Command.Line, x2, y2);
                    vertexCurve.addVertex(IFVertex.Command.Line, x3, y3);
                    vertexCurve.addVertex(IFVertex.Command.Line, x4, y4);
                    vertexCurve.addVertex(IFVertex.Command.Line, x1, y1);
                ...
                case 2:
                    ...
                    vertexSource.addVertex(IFVertex.Command.Close);
                    vertexCurve = new IFVertexContainer(5);
                    vertexCurve.addVertex(IFVertex.Command.Move, x2, y2);
                    vertexCurve.addVertex(IFVertex.Command.Curve2, x1, y1);
                    vertexCurve.addVertex(IFVertex.Command.Curve2, x3, y3);
                    vertexCurve.addVertex(IFVertex.Command.Curve2, x4, y4);
                    vertexCurve.addVertex(IFVertex.Command.Close);
                ...
                case 3:
                    ...
                    vertexSource.addVertex(IFVertex.Command.Close);
                    vertexCurve = new IFVertexContainer(5);
                    vertexCurve.addVertex(IFVertex.Command.Move, x2 + 20 - halfWidth, y1);
                    vertexCurve.addVertex(IFVertex.Command.Curve2, x2 - halfWidth, y2 / 2);
                    vertexCurve.addVertex(IFVertex.Command.Curve2, x4 - halfWidth, y4);
                    vertexCurve.addVertex(IFVertex.Command.Curve2, x3 - halfWidth, y3);
                    vertexCurve.addVertex(IFVertex.Command.Close);
...
//                        yPt = 150;
                ...
                case 4:
                    ...
                    vertexSource.addVertex(IFVertex.Command.Close);
                    vertexCurve = new IFVertexContainer(5);
                    vertexCurve.addVertex(IFVertex.Command.Move, x2, y1);
                    vertexCurve.addVertex(IFVertex.Command.Curve2, x1, y1);
                    vertexCurve.addVertex(IFVertex.Command.Curve2, x4, y4);
                    vertexCurve.addVertex(IFVertex.Command.Curve2, x3, y3);
                    vertexCurve.addVertex(IFVertex.Command.Close);
...
//                        yPt = 143;
                ...
                case 5:
                    ...
                    vertexSource = new IFVertexContainer(4);
                    ...
                    vertexSource.addVertex(IFVertex.Command.Close);
                    vertexCurve = new IFVertexContainer(4);
                    vertexCurve.addVertex(IFVertex.Command.Move,  x1 + 40, y1);
                    vertexCurve.addVertex(IFVertex.Command.Curve, cx, cy);
                    vertexCurve.addVertex(IFVertex.Command.Curve, x3, y3);
                    vertexCurve.addVertex(IFVertex.Command.Close);
                ...
                case 6:
                    ...
                    vertexCurve = new IFVertexContainer(4);
                    vertexCurve.addVertex(IFVertex.Command.Move, x1, y1);
                    vertexCurve.addVertex(IFVertex.Command.Curve, x4, y4);
                    vertexCurve.addVertex(IFVertex.Command.Curve, x2, cy);
                    vertexCurve.addVertex(IFVertex.Command.Close);
