    ...
    GImagePaletteMatcher.prototype.init = function (htmlElement) {
        ...
        $('<div></div>')
            ...
            .on('dragenter', function () {
                $(event.target).css('border', '2px solid maroon');
                return false;
            })
            ...
            .on('drop', function (event) {
                $(event.target).css('border', '2px solid white');
                this._handleImage(event.originalEvent.dataTransfer.files);
                return false;
            }.bind(this))
            ...
            if (file.type.match(imageType)) {
                ...
                reader.onload = function (event) {
                    ...
                    image.onload = function () {
                        ...
                        this._palette = [];
                        this._palette.push(this._convertThiefColor(colorThief.getColor(image)));
