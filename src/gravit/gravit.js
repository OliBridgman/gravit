(function (_) {
    ...
    GravitModule.prototype._createDefaultActions = function () {
        ...
        return [].concat(
            ...
            new GAlignAction(GAlignAction.Type.Left, false),
            new GAlignAction(GAlignAction.Type.Center, false),
            new GAlignAction(GAlignAction.Type.Right, false),
            new GAlignAction(GAlignAction.Type.Top, false),
            new GAlignAction(GAlignAction.Type.Middle, false),
            new GAlignAction(GAlignAction.Type.Bottom, false),
            new GAlignAction(GAlignAction.Type.Left, true),
            new GAlignAction(GAlignAction.Type.Center, true),
            new GAlignAction(GAlignAction.Type.Right, true),
            new GAlignAction(GAlignAction.Type.Top, true),
            new GAlignAction(GAlignAction.Type.Middle, true),
            new GAlignAction(GAlignAction.Type.Bottom, true),
