// Core
gLocale.setValues(GLocale, GLocale.Language.English, ["create", "add", "edit", "remove", "delete", "open", "save", "cancel", "ok", "close", "loading", "loading_of", "saving", "saving_of", "success", "failure", "waiting"],
...
gLocale.setValues(GUIKey, GLocale.Language.English, ["key.1"], ["Space"]);
gLocale.setValues(GUIKey, GLocale.Language.English, ["key.2"], ["Enter"]);
gLocale.setValues(GUIKey, GLocale.Language.English, ["key.3"], ["Tab"]);
gLocale.setValues(GUIKey, GLocale.Language.English, ["key.4"], ["Backspace"]);
gLocale.setValues(GUIKey, GLocale.Language.English, ["key.5", "key.5.short"], ["Control", "Ctrl"]);
gLocale.setValues(GUIKey, GLocale.Language.English, ["key.6"], ["Shift"]);
gLocale.setValues(GUIKey, GLocale.Language.English, ["key.7"], ["Alt"]);
gLocale.setValues(GUIKey, GLocale.Language.English, ["key.8"], ["Left"]);
gLocale.setValues(GUIKey, GLocale.Language.English, ["key.9"], ["Up"]);
gLocale.setValues(GUIKey, GLocale.Language.English, ["key.10"], ["Right"]);
gLocale.setValues(GUIKey, GLocale.Language.English, ["key.11"], ["Down"]);
gLocale.setValues(GUIKey, GLocale.Language.English, ["key.12"], ["Page Up"]);
gLocale.setValues(GUIKey, GLocale.Language.English, ["key.13"], ["Page Down"]);
gLocale.setValues(GUIKey, GLocale.Language.English, ["key.14"], ["Home"]);
gLocale.setValues(GUIKey, GLocale.Language.English, ["key.15"], ["End"]);
gLocale.setValues(GUIKey, GLocale.Language.English, ["key.16", "key.16.short"], ["Insert", "Ins"]);
gLocale.setValues(GUIKey, GLocale.Language.English, ["key.17", "key.17.short"], ["Delete", "Del"]);
gLocale.setValues(GUIKey, GLocale.Language.English, ["key.18", "key.18.short"], ["Escape", "Esc"]);
gLocale.setValues(GUIKey, GLocale.Language.English, ["key.19", "key.19.short"], ["Command", "Cmd"]);
...
gLocale.setValues(GXFillAttributes, GLocale.Language.English, ["name"], ["Fill"]);
gLocale.setValues(GXStrokeAttributes, GLocale.Language.English, ["name"], ["Stroke"]);
gLocale.setValues(GXContentsAttributes, GLocale.Language.English, ["name"], ["Contents"]);
