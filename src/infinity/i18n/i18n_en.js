...
ifLocale.setValues(IFGroup, IFLocale.Language.English, ["name"], ["Group"]);
...
ifLocale.setValues(IFCompoundPath, IFLocale.Language.English, ["name"], ["Compound Path"]);
...
ifLocale.setValues(IFBlurEffect, IFLocale.Language.English, ["name"], ["Blur"]);
ifLocale.setValues(IFColorGradingEffect, IFLocale.Language.English, ["name"], ["Color Grading"]);
ifLocale.setValues(IFColorMatrixEffect, IFLocale.Language.English, ["name"], ["Color Matrix"]);
ifLocale.setValues(IFColorTransformEffect, IFLocale.Language.English, ["name"], ["Color Transform"]);
